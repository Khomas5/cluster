...
class SpreadsheetIndividualCell extends internal_cjs.BaseComponent {
    ...
    render() {
        ...
        return (preact_cjs.createElement(internal_cjs.ContentContainer, { elTag: "td", elClasses: [
            ...
            }, renderProps: renderProps, generatorName: colSpec.isMain ? 'resourceLabelContent' : undefined, generator: colSpec.cellContent || renderResourceInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (preact_cjs.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
...
class SpreadsheetGroupCell extends internal_cjs.BaseComponent {
    render() {
        ...
        return (preact_cjs.createElement(internal_cjs.ContentContainer, { elTag: "td", elClasses: [
            ...
            }, renderProps: renderProps, generatorName: "resourceGroupLabelContent", generator: colSpec.cellContent || renderGroupInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (preact_cjs.createElement("div", { className: "fc-datagrid-cell-frame fc-datagrid-cell-frame-liquid" },
...
class SpreadsheetHeader extends internal_cjs.BaseComponent {
    ...
    render() {
        ...
        rowNodes.push(preact_cjs.createElement("tr", { key: "row", role: "row" }, colSpecs.map((colSpec, i) => {
            ...
            return (preact_cjs.createElement(internal_cjs.ContentContainer, { key: i, elTag: "th", elClasses: ['fc-datagrid-cell'], elAttrs: { role: 'columnheader' }, renderProps: renderProps, generatorName: "resourceAreaHeaderContent", generator: colSpec.headerContent, classNameGenerator: colSpec.headerClassNames, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, (InnerContent) => (preact_cjs.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
                preact_cjs.createElement("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
